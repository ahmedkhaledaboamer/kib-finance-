    ...
    <section className="relative   overflow-hidden">
      ...
      <div className=" p-[5%] relative z-10 text-center">
        <motion.div
          ...
          <p className="text-[#D4AF37] font-medium text-lg mb-12">
            فريقنا جاهز لمساعدتك في اختيار الحل التمويلي الأمثل
          </p>
          ...
          <div className="relative inline-block">
            ...
            <motion.button
              ...
              className="relative bg-[#D4AF37] text-[#1E3A5F] px-10 py-5 rounded-lg font-bold text-xl transition-all duration-300 inline-flex items-center gap-3 group shadow-[0_0_30px_rgba(212,175,55,0.4)] hover:shadow-[0_0_40px_rgba(212,175,55,0.6)] overflow-hidden"
              style={{
